...
public class CalculatorBean implements Serializable{
	...
	private String repaymentmode="按月还本息";
	...
	public double cal(){
		...
		double interest = 0;
		if((Math.pow(1+monthinterestrate,this.timelimit)-1)==0){
			return 0.0;
		}
		if(this.repaymentmode.equals("按月还本息")){
		...
		}else if(this.repaymentmode.equals("按季还本息")){
