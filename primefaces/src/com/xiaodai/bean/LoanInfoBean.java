...
public class LoanInfoBean implements Serializable{
	...
	public String webSiteNameChangeColor(){
		if(this.websiteName.equals("人人贷")){
			return "#1CA5B8";
		}else if(this.websiteName.equals("煜隆创投")){
			return "#1E56BD";
			...
			return "#070D0B";
		}else if(this.websiteName.equals("通融易贷")){
			return "#273833";
	...
	public String loanTypeChangeColor(){
		if(this.loanType.equals("信用标")){
			return "blue";
		}else if(this.loanType.equals("净值标")){
			return "#C4A00E";
